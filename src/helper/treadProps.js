const treadProps = {
  ...
  The backend was built using Express.js and Mongo DB. When a user enters the email and password to sign up a check is run to see if the email already exists. If it does not exist the email is stored as is in the database and the password is ran through bcrypt and after being encrypted is stored in the database.
  ...
  seeCodeUrl: "https://github.com/JesseSkralskis/TreadTrackApi",
  viewurl: "#",
  buttonColor: "#000000",
  headerColor: "#000000",
  photo: "/images/TreadTrackFinal.png",
  buttonHeight: "10",
};
